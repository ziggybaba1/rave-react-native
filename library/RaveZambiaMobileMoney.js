...
export default class RaveUgandaMobileMoney {
  constructor({ publicKey, encryptionKey, production = false, currency = "ZMW", country = "NG", txRef = "txref-" + Date.now(), network = "MTN", amount, paymenttype, orderRef = "orderref_" + Date.now(), email, firstname, lastname, is_mobile_money_ug = true, meta }) {
