...
export default class RaveUgandaMobileMoney {
  constructor({ publicKey, encryptionKey, currency = "UGX", country = "NG", txRef = "txref-" + Date.now(), network = "UGX", amount, orderRef = "orderref_" + Date.now(), email, firstname, lastname, is_mobile_money_ug = true }) {
