  ...
  check() {
    ...
    if (this.state.phonenumber.length < 3) {
      this.setState({
        ...
        Alert.alert(
          'Alert',
          'Amount can\'t be less than 1 RWF',
          [
            {
  ...
  pay() {
    if (this.check()) {
      ...
      this.props.rave.getAccountFees({ amount: this.props.amount, currency: this.props.currency }).then((resp) => {
        // Alert to display the charged amount in the RWF
        Alert.alert(
          '',
...
// This is the render function to render the payment interface
  render() {
    ...
    // this returns the Rwanda Mobile Money payment form
    return (
            ...
            <View style={styles.formGroup}>
              ...
              <Text
                style={{
                  color: "#EE312A",
                  fontSize: 10,
                  display: this.state.phonenumberErr,
                  fontWeight: "bold",
                  marginTop: 5
                }}
              >
