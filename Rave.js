...
export default class Rave extends React.Component {
  ...
  render() {
    ...
    if (
      ...
      this.props.paymentOption == "card,mpesa"
    ) {
      ...
      if (this.state.page == "card") {
        ...
        header2 = (
          <CardHeader
            page={this.getPage}
            showTwo={this.show}
            bottomTwo={this.state.bottomOne}
            colorTwo={this.state.colorTwo}
          />
        );
        page = <Home onClose={this.props.onClose} />;
      ...
      this.props.country == "GH" &&
      this.props.currency == "GHS" &&
      this.props.paymentOption == "card,mobilemoneygh"
    ) {
      if (this.state.page == "home") {
        this.state.bottomOne = 1;
        this.state.bottomTwo = 90;
      ...
      this.props.country == "GH" &&
      this.props.currency == "GHS" &&
      this.props.paymentOption == "mobilemoneygh"
    ) {
      if (this.state.page == "home") {
        this.state.bottomOne = 1;
        this.state.bottomTwo = 90;
      ...
      this.props.currency == "UGX" &&
      this.props.paymentOption == "card,mobilemoneyuganda"
    ) {
      if (this.state.page == "home") {
        this.state.bottomOne = 1;
        this.state.bottomTwo = 90;
      ...
      if (this.state.page == "mobilemoneyuganda") {
        ...
        page = (
          <UgMmoney
            rave={this.raveugandamobilemoney}
            primarycolor={this.props.primarycolor}
            phone={this.props.phone}
            secondarycolor={this.props.secondarycolor}
            amount={this.props.amount}
      ...
      this.props.currency == "UGX" &&
      this.props.paymentOption == "mobilemoneyuganda"
    ) {
      if (this.state.page == "home") {
        this.state.bottomOne = 1;
        this.state.bottomTwo = 90;
      ...
      this.props.currency == "ZMW" &&
      this.props.paymentOption == "card,mobilemoneyzambia"
    ) {
      if (this.state.page == "home") {
        this.state.bottomOne = 1;
        this.state.bottomTwo = 90;
      ...
      if (this.state.page == "mobilemoneyzambia") {
        ...
        page = (
          <ZMmoney
            rave={this.ravezambiamobilemoney}
            primarycolor={this.props.primarycolor}
            phone={this.props.phone}
            secondarycolor={this.props.secondarycolor}
            amount={this.props.amount}
      ...
      this.props.currency == "ZMW" &&
      this.props.paymentOption == "mobilemoneyzambia"
    ) {
      if (this.state.page == "home") {
        this.state.bottomOne = 1;
        this.state.bottomTwo = 90;
